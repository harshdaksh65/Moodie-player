  ...
  />
      ...
      <div className='flex flex-col gap-4 w-[90%] mx-auto mb-6 pt-4'>
        <div className="flex items-center justify-center mb-2">
          <h1
            className="text-xl xs:text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-purple-400 via-pink-400 to-yellow-400 bg-clip-text text-transparent text-center drop-shadow-lg relative transition-colors duration-1000 animate-gradient-x"
            style={{
